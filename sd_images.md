...
10. Выполнить настройку printer.cfg, используя документацию Klipper Configuration Reference, а также [гитхаб ТомТомыча](https://github.com/Tombraider2006/klipperFB6#klipper). Либо восстановить printer.cfg и другие файлы конфигурации из ранее сохранённых резервных копий.
